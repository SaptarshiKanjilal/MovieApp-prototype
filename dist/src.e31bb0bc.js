...
const API_KEY = 'fb327661776f57343ef57c7a2ff8caed';
...
async function fetchPopularMovies() {
  ...
  https://api.themoviedb.org/3/movie/popular?api_key=${_config.API_KEY}&language=en-US&page=1`);
...
async function loadPopularData() {
  ...
  (0, _view.clearSpinner)(); // console.log(results);
